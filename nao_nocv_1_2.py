...
def InitProxy(IP="marvin.local", proxy=[0], PORT = 9559):
    ...
    ALModuleList=["ALTextToSpeech","ALAudioDevice","ALMotion","ALMemory","ALFaceDetection","ALVideoDevice","ALLeds","ALFaceTracker","ALSpeechRecognition","ALAudioPlayer","ALVideoRecorder","ALSonar","ALRobotPosture","ALLandMarkDetection"]
    proxyDict={}
...
#    "Crouch"
    ...
    postureProxy.goToPosture(thePosture, 1.0)
